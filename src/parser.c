...
enum {
  ...
  anon_sym_LBRACK = 2,
  anon_sym_BSLASH = 3,
  aux_sym_regexPattern_token1 = 4,
  aux_sym_regexPattern_token2 = 5,
  anon_sym_RBRACK = 6,
  aux_sym_regexPattern_token3 = 7,
  sym_regexFlags = 8,
  anon_sym_STAR = 9,
  anon_sym_PLUS = 10,
  anon_sym_QMARK = 11,
  ...
  aux_sym_regexPattern_repeat1 = 30,
  aux_sym_regexPattern_repeat2 = 31,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_LBRACK] = "[",
  [anon_sym_BSLASH] = "\\",
  [aux_sym_regexPattern_token1] = "regexPattern_token1",
  [aux_sym_regexPattern_token2] = "regexPattern_token2",
  [anon_sym_RBRACK] = "]",
  [aux_sym_regexPattern_token3] = "regexPattern_token3",
  [sym_regexFlags] = "regexFlags",
  [anon_sym_STAR] = "*",
  [anon_sym_PLUS] = "+",
  [anon_sym_QMARK] = "\?",
  [anon_sym_AT] = "@",
  ...
  [sym_regexPattern] = "regexPattern",
  [sym_lines] = "lines",
  [sym_captureLabel] = "captureLabel",
  [sym_replaceStart] = "replaceStart",
  [sym_replaceEnd] = "replaceEnd",
  [aux_sym_query_repeat1] = "query_repeat1",
  [aux_sym_regexPattern_repeat1] = "regexPattern_repeat1",
  [aux_sym_regexPattern_repeat2] = "regexPattern_repeat2",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_regexPattern_token1] = aux_sym_regexPattern_token1,
  [aux_sym_regexPattern_token2] = aux_sym_regexPattern_token2,
  [anon_sym_RBRACK] = anon_sym_RBRACK,
  [aux_sym_regexPattern_token3] = aux_sym_regexPattern_token3,
  [sym_regexFlags] = sym_regexFlags,
  ...
  [sym_regexPattern] = sym_regexPattern,
  [sym_lines] = sym_lines,
  ...
  [aux_sym_regexPattern_repeat1] = aux_sym_regexPattern_repeat1,
  [aux_sym_regexPattern_repeat2] = aux_sym_regexPattern_repeat2,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_regexPattern_token1] = {
    .visible = false,
    .named = false,
  },
  [aux_sym_regexPattern_token2] = {
    .visible = false,
    .named = false,
  },
  [anon_sym_RBRACK] = {
  ...
  [aux_sym_regexPattern_repeat1] = {
    .visible = false,
    .named = false,
  },
  [aux_sym_regexPattern_repeat2] = {
    .visible = false,
    .named = false,
  },
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 9:
      ...
      END_STATE();
    case 10:
      ACCEPT_TOKEN(aux_sym_regexPattern_token1);
      END_STATE();
    case 11:
      ACCEPT_TOKEN(aux_sym_regexPattern_token1);
      if (lookahead == '\n' ||
      ...
      END_STATE();
    case 12:
      ACCEPT_TOKEN(aux_sym_regexPattern_token2);
      END_STATE();
    case 13:
      ACCEPT_TOKEN(aux_sym_regexPattern_token2);
      if (lookahead == '\n' ||
    ...
    case 14:
      ...
      END_STATE();
    case 15:
      ACCEPT_TOKEN(aux_sym_regexPattern_token3);
      END_STATE();
    case 16:
      ACCEPT_TOKEN(aux_sym_regexPattern_token3);
      if (lookahead == '\n' ||
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym_regexPattern_token1] = ACTIONS(1),
    [aux_sym_regexPattern_token2] = ACTIONS(1),
    [anon_sym_RBRACK] = ACTIONS(1),
    [aux_sym_regexPattern_token3] = ACTIONS(1),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_query_repeat1, 2), SHIFT_REPEAT(24),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_query_repeat1, 2), SHIFT_REPEAT(19),
  ...
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regexLiteral, 3),
  [60] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regex, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lines, 5),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regexLiteral, 4),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lines, 6),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replaceEnd, 1),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regex, 2),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replaceStart, 1),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_captureLabel, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_regexPattern, 1),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [84] = {.entry = {.count = 1, .reusable = false}}, SHIFT(23),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat2, 2),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat2, 2), SHIFT_REPEAT(29),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat2, 2), SHIFT_REPEAT(37),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_regexPattern_repeat2, 2), SHIFT_REPEAT(23),
  [97] = {.entry = {.count = 1, .reusable = false}}, SHIFT(22),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_regexPattern_repeat2, 2),
  ...
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat2, 3),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_regexPattern_repeat2, 3),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat1, 2), SHIFT_REPEAT(34),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_regexPattern_repeat1, 2), SHIFT_REPEAT(28),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_regexPattern_repeat1, 2),
  ...
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_regexPattern_repeat1, 2),
